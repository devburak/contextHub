...
const billingSubscriptionSchema = new Schema({
  ...
  cancellationRequestId: { type: String, default: null, trim: true },
  cancellationRequestedAt: { type: Date, default: null },
  cancellationEffectiveFrom: {
    type: String,
    enum: ['immediately', 'next_billing_period', null],
    default: null,
  },
  cancellationAttempts: { type: Number, default: 0, min: 0 },
  cancellationLastError: { type: String, default: '', maxlength: 2000 },
