...
Bu sayfadaki promptlar coding agent'lar için İngilizce hazırlanmıştır. Köşeli parantezli değerleri değiştirin ve gerçek token'ı hiçbir prompta yapıştırmayın.

## Content entegrasyonu geliştirin
...
## Public Collection görünümü geliştirin
...
## Authentication sınırlarını inceleyin
...
## Yönetilen semantic search ekleyin
...
## Dokümantasyon chatbot'u geliştirin
