...
- Sol menüde “Belgeler” sayfası (apps/admin/src/pages/docs/Documentation.jsx) artık API üzerinden feature flag tanımlarını çekip yeni bayraklar oluşturabiliyor; backend’de `FeatureFlagDefinition` modeli, `featureFlagService`, ve `/api/feature-flags` uçları eklendi.
