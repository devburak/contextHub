  ...
  fastify.put('/billing/profile', {
    ...
    schema: {
      body: {
        ...
        properties: {
          billingEmail: { type: 'string', format: 'email', minLength: 3, maxLength: 254 },
          legalName: { type: 'string', minLength: 2, maxLength: 200 },
          profileType: { type: 'string', enum: ['individual', 'business'] },
          contactFirstName: { type: 'string', minLength: 1, maxLength: 100 },
          contactLastName: { type: 'string', minLength: 1, maxLength: 100 },
          ...
          address: {
            ...
            properties: {
              line1: { type: 'string', minLength: 3, maxLength: 250 },
              line2: { type: 'string', maxLength: 250 },
              city: { type: 'string', minLength: 1, maxLength: 100 },
              district: { type: 'string', maxLength: 100 },
              region: { type: 'string', maxLength: 100 },
              postalCode: { type: 'string', minLength: 2, maxLength: 12 },
            },
          },
        },
      },
